-- GymBuddy — FULL RESET (MySQL / MariaDB)
-- WARNING: this DELETES all GymBuddy data, then recreates the tables fresh.
-- Run this in phpMyAdmin → select the `gymbuddy` database → SQL tab → paste → Go.
SET NAMES utf8mb4;
...
CREATE TABLE exercises (
  ...
  equipment_settings TEXT NULL,
  unit               VARCHAR(16) NULL,
  reps_per_minute    INT NULL,
  default_weight     DECIMAL(7,2) NULL,
  steps              TEXT NULL,
  default_duration_secs INT NULL,
  target_value       DECIMAL(9,2) NULL,
